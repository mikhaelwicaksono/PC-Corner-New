      ...
      <div class="col-lg-8 mx-auto my-5">
        ...
        <form action="/load/{{$numeric}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="mb-3">
              ...
              <textarea name="type" class="form-control" id="name" rows="1"
                  aria-label="(5-20 letters)" ></textarea>
            </div>
          ...
          <div class="mb-3">
              ...
              <textarea name="model_code" class="form-control" id="model-code" type="model-code"
               value={{$request->model_code}} aria-label="Device Factory Model Code"></textarea>
            </div>

          <div class="mb-3">
              <label for="quantity">Descryption</label>
              <textarea name="more_information" class="form-control" id="string"
