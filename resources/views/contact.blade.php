...
@section('content')
    <div class="container">
        <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light" style="background:transparent url('/assets/binus.png') no-repeat center center /cover">
            <div class="col-md-5 p-lg-9 mx-auto my-5">
              ...
              <div class="d-flex flex-row mb-3">
                ...
                <div class="p-2">Jl. Kemanggisan Ilir III No. 45, Kemanggisan, Palmerah, Jakarta Barat 11480, Indonesia</div>
        ...
        <div class="row mx-auto text-center">
            <div class="col-lg-4">
              <img class="bd-placeholder-img rounded-circle" width="140" height="140" src="{{url('/person/azhar.jpg')}}" alt="">
              <h4 class="fw-bold" style="margin-top: 10px">AZHAR BAGOES FAISHAL</h4>
              <p>Email :</p>
              <p style="margin-top: -20px">Phone Number :</p>
              </div><!-- /.col-lg-4 -->
            <div class="col-lg-4">
                <img class="bd-placeholder-img rounded-circle" width="140" height="140" src="{{url('/person/juan.jpg')}}" alt="">
                <h4 class="fw-bold" style="margin-top: 10px">JUANICO WIJAYA KUSUMA</h4>
                <p>Email :</p>
                <p style="margin-top: -20px">Phone Number :</p>            
                </div><!-- /.col-lg-4 -->
            <div class="col-lg-4">
                <img class="bd-placeholder-img rounded-circle" width="140" height="140" src="{{url('/person/ken.jpg')}}" alt="">
                <h4 class="fw-bold" style="margin-top: 10px">KEN VIRIYA</h4>
                <p>Email :</p>
                <p style="margin-top: -20px">Phone Number :</p>            
                </div><!-- /.col-lg-4 -->
            <div class="col-lg-4">
                <img class="bd-placeholder-img rounded-circle" width="140" height="140" src="{{url('/person/mikhael.jpg')}}" alt="">
                <h4 class="fw-bold" style="margin-top: 10px">MIKHAEL WICAKSONO MESTOKO</h4>
                <p>Email :</p>
                <p style="margin-top: -20px">Phone Number :</p>              
                </div><!-- /.col-lg-4 -->
              <div class="col-lg-4">
                <img class="bd-placeholder-img rounded-circle" width="140" height="140" src="{{url('/person/fiqri.jpg')}}" alt="">
